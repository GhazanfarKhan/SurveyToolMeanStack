...
gulp.task('clean:js', cb => del(paths.js + '**/*', cb));
gulp.task('clean:css', cb => del(paths.css + '**/*', cb));
gulp.task('clean:fonts', cb => del(paths.fonts + '**/*', cb));
gulp.task('clean:img', cb => del(paths.img + '**/*', cb));
